...
- M03's carrier-first epic (#2158) lands before M14 placement/drag/verb-bar work: the verb bar's slot control (#2075) is designed against the carrier model, not the slot_position pathway #2158 deletes.
...
- #2045 (export-all) moved into M14 to ride tabs; in server mode it flushes pending debounced saves before building the archive.
