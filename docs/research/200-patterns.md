...
**Scope:** Minor enhancements to existing DnD **Effort:** Low (1-2 small issues)
...
**Scope:** Add modal-based position selection **Effort:** Medium (1 feature issue)
...
**Scope:** Improve device import from NetBox **Effort:** Medium-Large (2-3 issues)
